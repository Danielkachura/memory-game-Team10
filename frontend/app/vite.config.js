    ...
    plugins: [
        react(),
        {
            ...
            configureServer: function (server) {
                var _this = this;
                server.middlewares.use("/api/claude", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                    var body;
                    var _this = this;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, handleClaudeProxy(payload)];
                                    case 1:
                                        result = _a.sent();
                                    ...
                                    case 2:
                                        ...
                                        res.end(JSON.stringify({
                                            error: error_1 instanceof Error ? error_1.message : "Claude proxy failed.",
                                        }));
                                        return [3 /*break*/, 3];
